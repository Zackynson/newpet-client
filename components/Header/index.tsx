...
const Header = () => {
  ...
  return <div style={{ width: '100%', padding: '1rem 1rem', height: '50px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
    ...
    <div onClick={logout}>
      ...
      <Image placeholder='blur' blurDataURL={AvatarPlaceholder.blurDataURL} src={user?.avatar || AvatarPlaceholder} loading='lazy' alt="avatar" height={35} width={35} quality={100}/></div>
    </div>
  </div>;
}
